    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">تعديل المدونة</h1>
                    <p class="text-gray-600 mt-2">تعديل المدونة: {{ $blog->title }}</p>
                </div>
                <div class="flex space-x-4">
                    <a href="{{ route('admin.blogs.show', $blog) }}" class="btn-secondary">
                        عرض المدونة
                    </a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group md:col-span-2">
                        ...
                        <textarea id="short_description" 
                                  ...
                                  class="form-textarea @error('short_description') border-red-500 @enderror">{{ old('short_description', $blog->short_description) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select id="is_published" 
                            ...
                            <option value="0" {{ old('is_published', $blog->is_published) == 0 ? 'selected' : '' }}>مسودة</option>
                            <option value="1" {{ old('is_published', $blog->is_published) == 1 ? 'selected' : '' }}>منشورة</option>
                        </select>
                        @error('is_published')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror

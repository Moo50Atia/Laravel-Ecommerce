...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="vendor_id" value="{{old("vendor_id", $order["vendor_id"])}}">
            @error("vendor_id")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="total_amount" value="{{old("total_amount", $order["total_amount"])}}">
            @error("total_amount")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="discount_amount" value="{{old("discount_amount", $order["discount_amount"])}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="shipping_amount" value="{{old("shipping_amount", $order["shipping_amount"])}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="grand_total" value="{{old("grand_total", $order["grand_total"])}}">
            @error("grand_total")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="shipping_address" value="{{old("shipping_address", $order["shipping_address"])}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="billing_address" value="{{old("billing_address", $order["billing_address"])}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="notes" value="{{old("notes", $order["notes"])}}">
            @error("notes")
                <p>{{$message}}</p>
            @enderror
        </div>

...
class ProductController extends Controller
{
    ...
    {
        $products = $this->productRepository->getForPublic(['per_page' => 10]);
        $special_products = $this->productRepository->getSpecialProducts(10);
    ...
    public function search(Request $request)
    {
        ...
        $products = $this->productRepository->getForPublic($filters);

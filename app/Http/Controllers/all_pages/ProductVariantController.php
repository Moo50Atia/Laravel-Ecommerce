...
class ProductVariantController extends Controller
{
    ...
    public function store(ProductVariantRequest $request)
    {
        ...
        try {
            DB::transaction(function () use ($variants, $validated) {
            ...
            return back()->withErrors(['error' => 'حدث خطأ أثناء حفظ الخصائص: ' . $e->getMessage()]);
        }
    ...
    public function update(ProductVariantRequest $request, $id)
    {
        ...
        try {
            ...
            return back()->withErrors(['error' => 'حدث خطأ أثناء تحديث الخصائص']);
        }
